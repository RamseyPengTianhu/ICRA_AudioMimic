...
Evaluations of 60\,s FineDance generations find that a frozen music--motion
evaluator favors the intended soundtrack in approximately 75\% of pairwise
comparisons. A separate, complete 18-track study characterizes the effects of
history regularization on motion fidelity, diversity, and smoothness.
Together with rendered references, these studies examine both musical
correspondence and the resulting motion. Section~\ref{sec:evidence_scope}
distinguishes these findings from the comparisons needed to attribute
forecast and component benefits.
