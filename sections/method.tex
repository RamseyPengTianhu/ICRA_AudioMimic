...
The forecaster remains frozen while the dance generator learns to interpret these states. A null condition bypasses music modulation and supports separately trained no-music controls. Section~\ref{sec:music_results} distinguishes the effect of using music from the additional question of whether forecast states improve on heard-music states.
