...
\begin{table}[t]
\centering
\caption{Preliminary placeholder: M3 generator-side evaluation on six 60-s G1 references. The D/M
scores are calibrated proximity scores (100 is the corresponding GT-stratum center),
not absolute dance-quality percentages. M3 is not the final model.}
\label{tab:m3_reference_eval}
\scriptsize
\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{@{}lcccccc@{}}
\toprule
Method & $n$ & D $\uparrow$ & M $\uparrow$ & BAS $\uparrow$ & Beat F1 $\uparrow$ & Recall $\uparrow$ \\
\midrule
M3 $M_{\mathrm{ref}}$ & 6 & 51.6 & 62.9 & 0.258 & 0.227 & 0.187 \\
\bottomrule
\end{tabular}
\end{table}
